...
| `LOCAL_FINANCE_DEFAULT_SYMBOLS` | 선택 | Trader finance cycle이 순환 평가할 기본 종목 유니버스. `005930,us_stock:AAPL`, `AAPL@us_stock`, `kr_options:K200_CALL_ATM` 형식을 지원하며 기본값은 `us_stock:NVDA,us_stock:TQQQ,us_stock:SOXL,us_stock:TSLA,005930,069500,233740,us_stock:AAPL`. `kr_options`는 콜옵션만 허용한다 |
