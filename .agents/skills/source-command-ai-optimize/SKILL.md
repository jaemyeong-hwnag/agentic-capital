---
name: "source-command-ai-optimize"
description: "AI 소비 최적화 — 토큰 최소화, AI 이해도 극대화 (LLMLingua-2, TOON, XML-tag 적용)"
---

# source-command-ai-optimize

Use this skill when the user asks to run the migrated source command `ai-optimize`.
...
**제외** (사람이 입력/읽는 것):
- `.env`, `.env.*` 환경변수 파일
- `*.md` 문서 파일 (README, CHANGELOG, AGENTS.md 등)
