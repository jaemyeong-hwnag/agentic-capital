---
name: "source-command-agent-orchestration"
description: "멀티 에이전트 조율 — CEO/Analyst/Trader 간 라우팅, 위임, 병렬 처리 설계"
---

# source-command-agent-orchestration

Use this skill when the user asks to run the migrated source command `agent-orchestration`.
