---
name: "source-command-hexagonal-development"
description: "Hexagonal Architecture 준수 — Core/Port/Adapter 경계 유지"
---

# source-command-hexagonal-development

Use this skill when the user asks to run the migrated source command `hexagonal-development`.
